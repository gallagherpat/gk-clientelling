    ...
    <div id="cust-info-long" className="place-content-center mx-6 my-3 drop-shadow-lg rounded-md flex justify-center bg-white text-lg">
        ...
        <div className="py-4 mx-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="26" viewBox="0 96 960 960" width="26">
                ...
                <p className="indent-1 font-bold">Member ID: 400117</p>
            </div>
                <h4 className="indent-8">Points:</h4>
                <h5 className="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" height="26" viewBox="0 96 960 960" width="26">
                    ...
                    <span className="indent-1 font-bold">Preferences</span>
                </h5>
                ...
                <p className="indent-16">placeholder</p>
            </div>
    </div>
    )}